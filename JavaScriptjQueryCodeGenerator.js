...
(function() {
  var JavaScriptjQueryCodeGenerator, addslashes;
  ...
  JavaScriptjQueryCodeGenerator = function() {
    ...
    this.body = function(request) {
      ...
      if (json_body) {
        return {
          "has_json_body": true,
          "json_body_object": this.json_body_object(json_body, 0)
        };
      }
  ...
  JavaScriptjQueryCodeGenerator.identifier = "com.luckymarmot.PawExtensions.JavaScriptjQueryCodeGenerator";

  JavaScriptjQueryCodeGenerator.title = "JavaScript (jQuery)";
